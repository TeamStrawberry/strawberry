...
const  Trending = ({ loggedInUser, setLoginOpen }) => {
  ...
  return (
    ...
    <Grid
      ...
      spacing={2}
    >
      { trendingQuizzes.map((quiz, index) =>  <QuizListCard quiz={ quiz } key={ index } loggedInUser={ loggedInUser } setLoginOpen={ setLoginOpen }/>) }
    </Grid>
  </div>
  );
}
